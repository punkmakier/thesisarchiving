                                ...
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
                                            <h2 class="ml-lg-2">List of All Accounts</h2>
                                        </div>
...
<br>
                                <table class="table table-striped" id="thisTable">
                                    ...
                                    <tbody>
                                        <?php $display->displayAccountsActive(); ?>
                                    </tbody>
                                </table>
                ...
                $( document ).ready( function () {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    if(response == "Success"){
                                        Swal.fire({
                                        title: 'Success',
                                        text: "You successfully delete this account",
                                        icon: 'success',
                    ...
                    $(".viewDetails").click(function(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "../Controller/AppDisApp.php",
                                data: {UID : id , Action: "showDetails"},
                                success: function (response) {
                                    $(".viewSelectedUserDetails").html(response)
                                }
                            })
